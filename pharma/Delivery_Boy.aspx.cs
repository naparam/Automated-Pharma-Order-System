...
public partial class Delivery_Boy : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        try
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select * from deliveryboy_table", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand("insert into deliveryboy_table values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "')", con);
        cmd.ExecuteNonQuery();
        con.Close();
        clear();
        BindData();
